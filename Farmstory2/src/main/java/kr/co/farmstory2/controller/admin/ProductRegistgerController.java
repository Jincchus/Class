...
public class ProductRegistgerController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String path = aService.getFilePath(req, "/thumb");
		...
		logger.debug("thumb120 : " + thumb1);
		logger.debug("thumb240 : " + thumb2);
		logger.debug("thumb750 : "+thumb3);
		...
		logger.debug("prodDto : " +dto.toString());
