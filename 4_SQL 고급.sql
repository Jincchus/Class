...
CREATE TABLE `Sales`(
	`seq`		INT AUTO_INCREMENT PRIMARY KEY UNIQUE,
...
#실습 4-2
INSERT INTO `Member` VALUE ('a101','박혁거세','010-1234-1001','부장',101,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a102','김유신'  ,'010-1234-1002','차장',101,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a103','김춘추'  ,'010-1234-1003','사원',101,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a104','장보고'  ,'010-1234-1004','대리',102,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a105','강감찬'  ,'010-1234-1005','과장',102,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a106','이성계'  ,'010-1234-1006','차장',103,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a107','정철'    ,'010-1234-1007','차장',103,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a108','이순신'  ,'010-1234-1008','부장',104,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a109','허균'    ,'010-1234-1009','부장',104,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a110','정약용'  ,'010-1234-1010','사원',105,'2023-06-16 15:50:00');
INSERT INTO `Member` VALUE ('a111','박지원'  ,'010-1234-1011','사원',105,'2023-06-16 15:50:00');
...
SELECT a.`seq`, a.`uid`, a.`sale`, b.`name`, b.`pos`, c.`name` FROM `Sales` AS a JOIN `Member` AS b ON a.uid = b.uid
SELECT a.`seq`, a.`uid`, a.`sale`, b.`name`, b.`pos`, c.`name` FROM `Sales` AS a JOIN `member` AS b ON a.uid = b.uid JOIN `Department` AS a c ON b.dep = c.depNo WHERE `sale` > 100000 ORDER BY `sale` DESC;
