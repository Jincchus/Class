...
<div id="sub">
	...
	<section class="market">
		...
		<article class="view">
			...
			<h3>기본정보</h3>
			<div class="basic">
				<img src="../images/market_item_thumb.jpg" alt="딸기 500g"> <a
					href="./order.html" class="btnOrder"> <img
					src="../images/market_btn_order.gif" alt="바로 구매하기">
				</a>
				<table border="0">
					<tbody>
						<tr>
						...
						<tr>
							<td>배송비</td>
							<td><span>5,000</span>원 <em>3만원 이상 무료배송</em></td>
						</tr>
						<tr>
							<td>판매가격</td>
							<td>4,000원</td>
