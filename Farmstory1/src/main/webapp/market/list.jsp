...
<div id="sub">
	...
	<section class="market">
		...
		<article class="list">
			...
			<!-- 컨텐츠 시작 -->
			<p class="sort">
				<a href="#" class="on">전체(10) |</a> <a href="#">과일 |</a> <a href="#">야채
					|</a> <a href="#">곡류</a>
			</p>
			<table border="0">
				<tbody>
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item1.jpg" alt="사과 500g">
						</a></td>
						<td>과일</td>
					...
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item2.jpg" alt="배 5kg">
						</a></td>
						<td>과일</td>
					...
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item3.jpg" alt="방울토마토">
						</a></td>
						<td>야채</td>
					...
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item4.jpg" alt="딸기 500g">
						</a></td>
						<td>과일</td>
					...
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item5.jpg" alt="오렌지">
						</a></td>
						<td>과일</td>
						<td><a href="#">오렌지</a></td>
					...
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item6.jpg" alt="무농약현미">
						</a></td>
						<td>곡류</td>
						<td><a href="#">사과 500g</a></td>
					...
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item7.jpg" alt="팜스토리 하루야채 샐러드">
						</a></td>
						<td>야채</td>
						<td><a href="#">팜스토리 하루야채 샐러드</a></td>
						<td><strong>9,9000</strong>원</td>
					</tr>
					<tr>
						<td><a href="./view.html"> <img
								src="../images/market_item8.jpg" alt="바나나">
						</a></td>
						<td>과일</td>
						<td><a href="#">바나나</a></td>
