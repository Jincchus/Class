				...
				<form id="formOrder" action="/Farmstory1/market/proc/orderProc.jsp">
					...
					<table border="0">
						<tbody>
							<tr>
								<td>주문자</td>
								<td><input type="text" name="orderUser" readonly value="<%= sessUser.getUid()%>" ></td>
							</tr>
							<tr>
								<td>받는분</td>
								<td><input type="text" name="receiver" value="<%= sessUser.getUid() %>"></td>
							</tr>
							<tr>
								<td>휴대폰</td>
							...
							<tr>
								<td>기타</td>
								<td><textarea name="orderEtc"></textarea></td>
							</tr>
						</tbody>
					</table>
				</form>
