            ...
            <section class="view">
                ...
                <article class="info">
                    ...
                    <div class="summary">
                        ...
                        <img src="/KMarket/product/img/vip_plcc_banner.png" alt="100원만 결제해도 1만원 적립!" class="banner">
                        <div class="count">
                ...
                <article class="detail">
                    ...
                    <img src="http://via.placeholder.com/860x460" alt="상세페이지1">
                    <img src="http://via.placeholder.com/860x460" alt="상세페이지2">
                    <img src="http://via.placeholder.com/860x460" alt="상세페이지3">
                </article>
                <!-- 상품 정보 제공 고시 내용 -->
