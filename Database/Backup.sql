...
INSERT INTO `bank_account` (`a_no`, `a_item_dist`, `a_item_name`, `a_c_no`, `a_balance`, `a_open_date`) VALUES
	('101-11-1001', 'S1', '자유저축예금', '740423-1000001', 400000, '2005-07-21'),
...
-- edr3 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `edr3` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `edr3`;

-- 테이블 edr3.lecture 구조 내보내기
CREATE TABLE IF NOT EXISTS `lecture` (
  `lecNo` int NOT NULL,
  `lecName` varchar(20) NOT NULL,
  `lecCredit` int NOT NULL,
...
-- 테이블 데이터 edr3.lecture:~7 rows (대략적) 내보내기
INSERT INTO `lecture` (`lecNo`, `lecName`, `lecCredit`, `lecTime`, `lecClass`) VALUES
	(159, '인지행동심리학', 3, 40, '본304'),
	(167, '운영체제론', 3, 25, '본B05'),
	(234, '중급 영문법', 3, 20, '본201'),
...
-- 테이블 데이터 edr3.register:~8 rows (대략적) 내보내기
INSERT INTO `register` (`regStdNo`, `regLecNo`, `regMidScore`, `regFinalScore`, `regTotalScore`, `regGrade`) VALUES
	('20201016', 167, 18, 38, 56, 'F'),
	('20201016', 248, 24, 62, 86, 'B'),
	('20201016', 253, 28, 40, 68, 'D'),
...
-- 테이블 edr3.student 구조 내보내기
CREATE TABLE IF NOT EXISTS `student` (
  `stdNo` char(8) NOT NULL,
  `stdName` varchar(20) NOT NULL,
  `stdHp` char(13) NOT NULL,
  `stdYear` int NOT NULL,
  `atdAddress` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`stdNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 edr3.student:~6 rows (대략적) 내보내기
INSERT INTO `student` (`stdNo`, `stdName`, `stdHp`, `stdYear`, `atdAddress`) VALUES
	('20201016', '김유신', '010-1234-1001', 3, NULL),
	('20201126', '김춘추', '010-1234-1002', 3, '경상남도 경주시'),
	('20210216', '장보고', '010-1234-1003', 2, '전라남도 완도시'),
	('20210326', '강감찬', '010-1234-1004', 2, '서울시 영등포구'),
...
CREATE TABLE IF NOT EXISTS `department` (
  ...
  `dptell` varchar(13) NOT NULL,
  PRIMARY KEY (`dpno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 erd1.department:~7 rows (대략적) 내보내기
INSERT INTO `department` (`dpno`, `dpname`, `dptell`) VALUES
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  CONSTRAINT `fk_Member_Department` FOREIGN KEY (`dep`) REFERENCES `department` (`dpno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 erd1.member:~11 rows (대략적) 내보내기
INSERT INTO `member` (`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES
	('a101', '박혁거세', '010-1234-1001', '부장', 101, '2023-06-16 15:50:00'),
	('a102', '김유신', '010-1234-1002', '차장', 101, '2023-06-16 15:50:00'),
	('a103', '김춘추', '010-1234-1003', '사원', 101, '2023-06-16 15:50:00'),
	('a104', '장보고', '010-1234-1004', '대리', 102, '2023-06-16 15:50:00'),
	('a105', '강감찬', '010-1234-1005', '과장', 102, '2023-06-16 15:50:00'),
	('a106', '이성계', '010-1234-1006', '차장', 103, '2023-06-16 15:50:00'),
	('a107', '정철', '010-1234-1007', '차장', 103, '2023-06-16 15:50:00'),
	('a108', '이순신', '010-1234-1008', '부장', 104, '2023-06-16 15:50:00'),
	('a109', '허균', '010-1234-1009', '부장', 104, '2023-06-16 15:50:00'),
	('a110', '정약용', '010-1234-1010', '사원', 105, '2023-06-16 15:50:00'),
	('a111', '박지원', '010-1234-1011', '사원', 105, '2023-06-16 15:50:00');
...
INSERT INTO `doctors` (`doc_id`, `doc_name`, `doc_birth`, `doc_gen`, `dep_no`, `doc_pos`, `doc_phone`, `doc_email`) VALUES
	...
	('D103101', '장보고', '1979-07-28', 'M', '103', '과장', '010-3101-1979', 'jagbg@bw.com'),
	...
	('D107103', '이이', '1992-0907', 'M', '107', '전문의', '010-7103-1992', 'leelee@bw.com'),
...
INSERT INTO `nurses` (`nur_id`, `nur_name`, `nur_birth`, `nur_gender`, `dep_no`, `nur_pos`, `nur_phone`, `nur_email`) VALUES
	...
	('N108101', '송중기', '1992-10-07', 'M', '108', '간호사', '010-710-9210', 'jungi@bw.com');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `leaveData` datetime DEFAULT NULL,
  PRIMARY KEY (`uid`),
...
INSERT INTO `user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `role`, `zip`, `addr1`, `addr2`, `regip`, `regDate`, `leaveData`) VALUES
	('3soon', '3soon', '삼순', 'soon', '3soon@daum.net', '010-2222-2222', 'USER', '', '', '', '0:0:0:0:0:0:0:1', '2023-08-02 12:33:58', NULL),
	('a201', '1234', '홍길동', '길동홍', 'gildong@naver.com', '010-9999-9999', 'USER', '', '', '', '0:0:0:0:0:0:0:1', '2023-08-02 12:04:02', NULL),
	('bacchus', 'bacchus', '박카스', '카스', 'bacchus@google.com', '010-1111-1111', 'USER', '', '', '', '0:0:0:0:0:0:0:1', '2023-08-02 12:33:17', NULL),
	('chopoo2001', 'qwe123!@#', '박경진', '진이', 'chopoo2001@naver.com', '010-1234-4567', 'USER', '46084', '부산 기장군 기장읍 공수해안길 2', '', '0:0:0:0:0:0:0:1', '2023-08-03 17:23:40', NULL),
	('박경진', '1234', '박경진', '박경진', 'qkrrudwls@qkrrudwls.qkrrudwls', '010-0000-0000', 'USER', '', '', '', '0:0:0:0:0:0:0:1', '2023-08-02 11:57:29', NULL),
	('박정진', '', '박정진', '박정진', 'wjdwls@naver.com', '010-8888-8888', 'USER', '', '', '', '0:0:0:0:0:0:0:1', '2023-08-02 12:35:22', NULL);
...
-- 테이블 데이터 market_db.buy:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 market_db.member:~0 rows (대략적) 내보내기
...
INSERT INTO `customer` (`custId`, `name`, `hp`, `addr`, `rdate`) VALUES
	('1', '1', '10', '0', '2023-07-14'),
	('a101', 'ㄷㄷㄷ', '010-1234-5678', '부산', '2023-07-13'),
	('aaaa', 'aaaa', '010-9999-9999', 'aaaa', '2023-07-13'),
...
-- 테이블 데이터 shop.order:~16 rows (대략적) 내보내기
INSERT INTO `order` (`orderNo`, `orderId`, `orderProduct`, `orderCount`, `orderDate`) VALUES
	...
	(11, 'a101', 2, 5, '2023-07-14 10:36:15'),
	(12, 'a101', 11, 10, '2023-07-14 10:36:28'),
	(13, 'a101', 20, 20, '2023-07-14 10:36:33'),
	(14, 'a101', 2, 10, '2023-07-14 11:11:49'),
	(15, 'a101', 2, 5, '2023-07-14 11:35:40'),
	(16, 'a101', 7, 3, '2023-07-14 12:02:59'),
	(17, 'a101', 1, 6, '2023-07-14 12:04:07'),
	(18, 'c101', 3, 3, '2023-07-14 12:05:14');
...
INSERT INTO `product` (`prodNo`, `prodName`, `stock`, `price`, `company`) VALUES
	(1, '새우깡', 4994, 1500, '농심'),
	(2, '초코파이', 2485, 2500, '오리온'),
	(3, '포카칩', 3597, 1700, '오리온'),
	(4, '양파링', 1250, 1800, '농심'),
	(5, '죠리퐁', 2200, NULL, '크라운'),
	(6, '마카렛트', 3500, 3500, '롯데'),
	(7, '뿌셔뿌셔', 1647, 1200, '오뚜기');
...
INSERT INTO `carts` (`cartNo`, `userId`, `prodNo`, `cartProdCount`, `cartProdDate`) VALUES
	(1, 'user1', 100101, 1, '2023-06-29 16:02:57'),
	(2, 'user1', 100110, 2, '2023-06-29 16:02:57'),
	(3, 'user3', 120103, 1, '2023-06-29 16:02:57'),
	(4, 'user4', 130112, 1, '2023-06-29 16:02:57'),
	(5, 'user5', 130101, 1, '2023-06-29 16:02:57'),
	(6, 'user2', 110101, 3, '2023-06-29 16:02:57'),
	(7, 'user2', 160103, 1, '2023-06-29 16:02:57'),
	(8, 'user2', 170115, 1, '2023-06-29 16:02:57'),
	(9, 'user3', 110101, 1, '2023-06-29 16:02:57'),
	(10, 'user6', 130101, 1, '2023-06-29 16:02:57');
...
-- 테이블 데이터 shopping.orderitems:~12 rows (대략적) 내보내기
INSERT INTO `orderitems` (`itemNo`, `orderNo`, `prodNo`, `itemPrice`, `itemDiscount`, `itemCount`) VALUES
	...
	(12, '22010210001', 170115, 900000, 12, 1),
	(13, '22010510031', 120103, 21000, 10, 5);
...
INSERT INTO `orders` (`orderNo`, `userId`, `orderTotalPrice`, `orderAddr`, `orderStatus`, `orderDate`) VALUES
	('22010210001', 'user2', 52300, '서울시 마포구 121', 1, '2023-06-29 16:02:31'),
	('22010210002', 'user3', 56700, '서울시 강남구 21-1', 1, '2023-06-29 16:02:31'),
	('22010210010', 'user4', 72200, '서울시 강서구 큰대로 38', 2, '2023-06-29 16:02:31'),
	('22010310000', 'user1', 120000, '경기도 수원시 120번지', 0, '2023-06-29 16:02:31'),
	('22010310001', 'user5', 127000, '경기도 광주시 초월로 21', 1, '2023-06-29 16:02:31'),
	('22010410101', 'user6', 792000, '부산시 남구 21-1', 2, '2023-06-29 16:02:31'),
	('22010510021', 'user7', 92200, '부산시 부산진구 56 10층', 4, '2023-06-29 16:02:31'),
	('22010510027', 'user8', 112000, '대구시 팔달로 19', 3, '2023-06-29 16:02:31'),
	('22010510031', 'user10', 792000, '대전시 한밭로 24-1', 2, '2023-06-29 16:02:31'),
	('22010710110', 'user9', 94500, '광주시 충열로 11', 1, '2023-06-29 16:02:31');
...
INSERT INTO `points` (`pointNo`, `userId`, `point`, `pointDesc`, `pointDate`) VALUES
	(1, 'user1', 1000, '회원가입 1000 적립', '2023-06-29 16:02:16'),
	(2, 'user1', 6000, '상품구매 5% 적립', '2023-06-29 16:02:16'),
	(3, 'user3', 2835, '상품구매 5% 적립', '2023-06-29 16:02:16'),
	(4, 'user7', 3610, '상품구매 5% 적립', '2023-06-29 16:02:16'),
	(5, 'user5', 3000, '이벤트 응모 3000 적립', '2023-06-29 16:02:17'),
	(6, 'user2', 1000, '회원가입 1000 적립', '2023-06-29 16:02:17'),
	(7, 'user2', 2000, '이벤트 응모 2000 적립', '2023-06-29 16:02:17'),
	(8, 'user2', 2615, '상품구매 5% 적립', '2023-06-29 16:02:17'),
	(9, 'user3', 1500, '이벤트 응모 1500 적립', '2023-06-29 16:02:17'),
	(10, 'user6', 15840, '상품구매 2% 적립', '2023-06-29 16:02:17');
...
INSERT INTO `users` (`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userEmail`, `userPoint`, `userLeverl`, `userAddr`, `userRegDate`) VALUES
	('user1', '김유신', '1976-01-21', 'M', '010-1101-1976', 'kimys@naver.com', 0, 1, '서울', '2023-06-29 16:02:16'),
	('user10', '허난설헌', '1992-09-07', 'F', '010-7103-1992', NULL, 4100, 3, '광주', '2023-06-29 16:02:16'),
	('user2', '계백', '1975-06-11', 'M', '010-1102-1975', NULL, 1000, 1, '서울', '2023-06-29 16:02:16'),
	('user3', '김춘추', '1989-05-30', 'M', '010-1103-1989', NULL, 1200, 2, '서울', '2023-06-29 16:02:16'),
	('user4', '이사부', '1979-04-13', 'M', '010-2101-1979', 'leesabu@gmail.com', 2600, 1, '서울', '2023-06-29 16:02:16'),
	('user5', '장보고', '1966-09-12', 'M', '010-2104-1966', 'jangbg@naver.com', 9400, 4, '대전', '2023-06-29 16:02:16'),
	('user6', '선덕여왕', '1979-07-28', 'M', '010-3101-1979', 'gueen@naver.com', 1600, 2, '대전', '2023-06-29 16:02:16'),
	('user7', '강감찬', '1984-06-15', 'F', '010-4101-1984', 'kang@daum.net', 800, 0, '대구', '2023-06-29 16:02:16'),
	('user8', '신사임당', '1965-10-21', 'M', '010-5101-1965', 'sinsa@gmail.com', 1500, 1, '대구', '2023-06-29 16:02:16'),
	('user9', '이이', '1972-11-28', 'F', '010-6101-1972', 'leelee@nate.com', 3400, 3, '부산', '2023-06-29 16:02:16');
...
CREATE TABLE IF NOT EXISTS `department` (
  `depNo` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `register` (`stdNo`, `lecNo`, `proNo`, `regAttenScore`, `regMidScore`, `regFinalScore`, `regEtcScore`, `regTotal`, `regGrade`) VALUES
	('20101001', '101001', 'P10101', 14, 30, 9, NULL, 18, 'F'),
	('20101001', '101002', 'P10102', 54, 41, 44, NULL, 46, 'F'),
	('20101001', '101003', 'P10102', 96, 48, 50, NULL, 65, 'D'),
	('20111013', '111011', 'P11103', 6, 80, 80, NULL, 55, 'F'),
	('20111013', '111012', 'P11104', 62, 67, 50, NULL, 60, 'D'),
	('21231002', '231110', 'P23102', 46, 82, 72, NULL, 67, 'D'),
	('22401001', '401019', 'P40101', 14, 54, 28, NULL, 32, 'F'),
	('22401001', '421012', 'P42103', 78, 4, 84, NULL, 55, 'F'),
	('22421003', '311003', 'P31104', 11, 99, 62, NULL, 57, 'F'),
	('22421003', '421012', 'P42103', 14, 84, 75, NULL, 58, 'F');
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  CONSTRAINT `fk_Students_Department1` FOREIGN KEY (`depNo`) REFERENCES `department` (`depNo`),
...
-- 테이블 데이터 userdb.child:~2 rows (대략적) 내보내기
INSERT INTO `child` (`cid`, `name`, `hp`, `pid`) VALUES
	('C101', '박경진', '010-9929-1111', 'P101'),
	('C102', '박정진', '010-9928-1111', 'P102');
...
-- 테이블 데이터 userdb.member:~11 rows (대략적) 내보내기
INSERT INTO `member` (`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES
	('a101', '박혁거세', '010-1234-1001', '부장', 101, '2023-06-16 15:50:00'),
	('a102', '김유신', '010-1234-1002', '차장', 101, '2023-06-16 15:50:00'),
	('a103', '김춘추', '010-1234-1003', '사원', 101, '2023-06-16 15:50:00'),
	...
	('a110', '정약용', '010-1234-1010', '사원', 105, '2023-06-16 15:50:00'),
	('a111', '박지원', '010-1234-1011', '사원', 105, '2023-06-16 15:50:00'),
	('b101', '을지문덕', '010-5555-1234', '사장', 107, '2023-06-19 14:49:55');
...
-- 테이블 데이터 userdb.parent:~2 rows (대략적) 내보내기
INSERT INTO `parent` (`pid`, `name`, `hp`) VALUES
	('P101', '박춘수', NULL),
	('P102', '전호정', '010-5676-1111');
...
INSERT INTO `tblproduct` (`prdCode`, `prdName`, `prdPrice`, `prdAmount`, `prdCompany`, `prdMakeDate`) VALUES
	(1, '냉장고', 800, 10, 'LG', '2023-06-16'),
	(2, '노트북', 1200, 20, '삼성', '2023-06-16'),
	(3, 'TV', 1400, 6, 'LG', '2023-06-16'),
	(4, '세탁기', 1000, 8, 'LG', '2023-06-16'),
	(5, '컴퓨터', 1100, 0, '삼성', '2023-06-16'),
	(6, '휴대폰', 900, 102, '삼성', '2023-06-16');
...
INSERT INTO `user2` (`uid`, `name`, `hp`, `age`) VALUES
	('aaa', 'aaa', '010-0000-0000', 55),
	('bbbb', 'bbbb', '111-1111-1111', 11),
	('ccc', 'cc', '111-1111-1111', 11),
	('eee', 'eee', '010-2222-2222', 22);
...
INSERT INTO `user3` (`uid`, `name`, `hp`, `age`) VALUES
	('A101', '박경진', '010-9929-1111', 29),
	('A102', '박정진', '010-0000-1111', 23),
	('A103', '박카스', NULL, 5),
	('A104', '신이수', '010-2016-1111', 27),
...
-- 테이블 데이터 userdb.user6:~2 rows (대략적) 내보내기
INSERT INTO `user6` (`uid`, `name`, `hp`, `age`) VALUES
	('a102', '김유신', '010-9999-888', 25);
